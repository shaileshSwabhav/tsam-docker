		...
		editor.addCommand('simage', {
			exec: function (editor) {
				...
				a.onchange = function () {
					...
					// // If production give file upload path.
					// let fileUploadLocation = "https://swabhavtechlabs.com/test/tsm_uploads/"

					// // If testing give file upload path.
					// if (Constant.BASE_URL === Constant.BASE_URL) {
					// 	fileUploadLocation = "https://swabhavtechlabs.com/test/tsm_uploads/testing/"
					// }
					...
					console.log("#n fileName :", fileName)
					// Get folder path from editor config.
					let folderPath = editor.config.folderPath
					console.log("#n folderPath :", folderPath)

					// Get file upload location form editor config.
					let fileUploadLocation = editor.config.fileUploadLocation
					console.log("#n fileUploadLocation :", fileUploadLocation)

					// Create file URL.
					let fileURL = fileUploadLocation + folderPath + fileName
					console.log("#n fileURL :", fileURL)
