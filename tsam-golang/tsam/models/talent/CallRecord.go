...
// CallRecord contains the call record details of talent which are enough for adding and updating call record.
...
// CallRecordDTO contains the complete information of talent call record which is needed to display.
