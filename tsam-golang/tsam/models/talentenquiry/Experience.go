...
// Experience contains the experience details of enquiry which are enough for adding and updating enquiry experience.
type Experience struct {
	general.TenantBase

	// Maps.
	Technologies []*general.Technology `json:"technologies" gorm:"many2many:talent_enquiry_experiences_technologies;ASSOCIATION_AUTOCREATE:false;association_autoupdate:false"`
...
// TableName will name the table of Experience model as "talent_enquiry_experiences".
func (*Experience) TableName() string {
	return "talent_enquiry_experiences"
}
...
func (*ExperienceTechnology) TableName() string {
	return "talent_enquiry_experiences_technologies"
}

//************************************* DTO MODEL *************************************************************

// ExperienceDTO contains the complete information of enquiry experience which is needed to display.
type ExperienceDTO struct {
	ID        uuid.UUID  `json:"id"`
	DeletedAt *time.Time `json:"-"`

	// Maps.
	Technologies []*general.Technology `json:"technologies" gorm:"many2many:talent_enquiry_experiences_technologies;association_jointable_foreignkey:technology_id;jointable_foreignkey:experience_id"`
